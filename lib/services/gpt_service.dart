...
''';
  ...
  Future<String> summarizeConversation() async {
    ...
    // デバッグ用に強制的にモック応答を返す場合はここをtrueにする
    bool useDebugMockSummary = true; // 一時的にtrueに設定してテスト
    if (useDebugMockSummary && kDebugMode) {
      // 会話内容から具体的なキーワードを抽出してバリエーションを作る
      final moodResponses = {
        '喜': [
          "【ユーザーの振り返り】\nユーザーさんは、喜びに満ちた一日を過ごされたようです。${_conversationHistory.isNotEmpty ? _conversationHistory.first.content.substring(0, min(20, _conversationHistory.first.content.length)) : ''}...という体験が心に残っているようでした。\n\n【アドバイス】\nこの喜びの感情を大切に、明日も小さな幸せを見つけていけるといいですね。",
          "【ユーザーの振り返り】\n今日は特別な喜びがあったようですね。その嬉しい気持ちを言葉にしてくださったことで、より深く味わえたのではないでしょうか。\n\n【アドバイス】\n喜びの記憶は心の栄養です。今夜はその温かな気持ちと共に、ゆっくりお休みください。",
        ],
        '怒': [
          "【ユーザーの振り返り】\nユーザーさんは、今日感じた怒りや苛立ちを正直に表現してくださいました。その感情も大切な心の声です。\n\n【アドバイス】\n怒りを認めることで、少しずつ心が軽くなります。深呼吸をして、明日は新しい気持ちでスタートしましょう。",
          "【ユーザーの振り返り】\n今日は思い通りにいかないことがあり、フラストレーションを感じられたようです。その気持ちを言葉にできたことは大きな一歩です。\n\n【アドバイス】\n感情を整理できた今、ゆっくりと体を休めて、明日への活力を蓄えてください。",
        ],
        '哀': [
          "【ユーザーの振り返り】\nユーザーさんは、今日感じた悲しみや寂しさを素直に表現してくださいました。その勇気に心から敬意を表します。\n\n【アドバイス】\n悲しみも大切な感情です。今夜は自分に優しくして、ゆっくりと心を休めてください。",
          "【ユーザーの振り返り】\n今日は心が重い一日だったようですね。でも、その気持ちを誰かに伝えられたことで、少し楽になれたのではないでしょうか。\n\n【アドバイス】\n明日は今日より少し軽い気持ちで過ごせますように。温かい布団で、ゆっくりお休みください。",
        ],
        '楽': [
          "【ユーザーの振り返り】\nユーザーさんは、楽しい時間を過ごされたようです。その充実感が言葉から伝わってきました。\n\n【アドバイス】\n楽しい記憶を胸に、今夜は心地よい眠りにつけることでしょう。明日も素敵な一日になりますように。",
          "【ユーザーの振り返り】\n今日の楽しかった出来事を振り返ることで、その幸せをもう一度味わえたのではないでしょうか。\n\n【アドバイス】\nこの満足感を大切に、リラックスして眠りについてください。良い夢が見られますように。",
        ],
        '疲': [
          "【ユーザーの振り返り】\nユーザーさんは、今日一日本当によく頑張られました。疲れを感じるのは、それだけ真剣に取り組んだ証です。\n\n【アドバイス】\n今夜はゆっくりと体を休めて、明日への英気を養ってください。お疲れさまでした。",
          "【ユーザーの振り返り】\n疲労感を素直に認めることで、心身のケアの第一歩を踏み出せました。自分の状態を大切にする姿勢が素晴らしいです。\n\n【アドバイス】\n深い呼吸と共に、今日の疲れを手放していきましょう。質の良い睡眠が取れますように。",
        ],
        '焦': [
          "【ユーザーの振り返り】\nユーザーさんは、焦りや不安を感じながらも、それと向き合う勇気を持たれました。その正直さが印象的でした。\n\n【アドバイス】\n焦る気持ちも、大切にしたいことがある証拠。今夜は一旦リセットして、明日また一歩ずつ進みましょう。",
          "【ユーザーの振り返り】\n今日感じた焦りや緊張感を言葉にすることで、少し整理できたのではないでしょうか。\n\n【アドバイス】\n明日は今日より落ち着いて物事に取り組めるはず。今は心を休めることに集中してください。",
        ]
      };
      
      final responses = moodResponses[_currentMood] ?? [
        "【ユーザーの振り返り】\nユーザーさんは、今日の出来事や感情を素直に表現してくださいました。その姿勢が心に響きました。\n\n【アドバイス】\n今日の振り返りを大切に、穏やかな眠りについてください。明日がより良い一日になりますように。"
      ];
