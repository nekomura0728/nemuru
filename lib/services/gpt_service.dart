...
6. 会話の終了の目安：
   ...
   - ユーザーが「もう大丈夫そう」「話せてよかった」といった気持ちになれるような終わり方が理想です。場合は、自然に会話を終了に導く
...
''';
  ...
  Future<String> summarizeConversation() async {
    ...
    messagesForSummary.add({
      'role': 'system',
      'content': 'あなたはユーザーの心理カウンセラーです。以下の会話を元に、ユーザーの心の状態や考えを理解し、有益なアドバイスや気づきを提供してください。ユーザーが自分自身の心の状態を理解し、前向きな考え方を見つけるためのヒントを含めてください。心理学的な洞察と具体的なアドバイスを含め、100文字から150文字程度でまとめてください。これはユーザーが後で振り返るためのメモとして使用されます。',
    });
