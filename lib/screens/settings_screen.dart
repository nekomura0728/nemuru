              ...
              Padding(
                ...
                child: OutlinedButton(
                  onPressed: () async {
                    ...
                    await subscriptionService.forceResetToFree();
                    if (mounted) {
                      ScaffoldMessenger.of(context).showSnackBar(
                        const SnackBar(content: Text('デバッグ: 購入状態をリセットしました')),
                      );
                    }
                  },
                  style: OutlinedButton.styleFrom(
                  ...
                  child: const Text('デバッグ: 購入状態をリセット', style: TextStyle(color: Colors.red)),
                ),
              ),
          ],
        ),
  ...
  void _showSubscriptionDialog(BuildContext context) {
    ...
    showDialog(
      ...
      builder: (context) => AlertDialog(
        title: const Text('プレミアムサブスクリプション'),
        content: Column(
          mainAxisSize: MainAxisSize.min,
          children: [
            // サブスクリプションタイトルとタイプを明記
            const Text(
              'ねむるプレミアム - 自動更新サブスクリプション',
            ...
            if (monthlyProduct != null) 
              Column(
                children: [
                  const Text('月額プラン', style: TextStyle(fontSize: 14)),
                  Text(
                    '${monthlyProduct.price} / 月',
              ...
              Column(
                children: const [
                  Text('月額プラン', style: TextStyle(fontSize: 14)),
                  Text(
                    '¥500 / 月 (デバッグ用)',
            ...
            if (yearlyProduct != null) ...[
              ...
              Column(
                children: [
                  const Text('年額プラン (お得)', style: TextStyle(fontSize: 14)),
                  Text(
                    '${yearlyProduct.price} / 年',
              ...
              Column(
                children: const [
                  Text('年額プラン (お得)', style: TextStyle(fontSize: 14)),
                  Text(
                    '¥5,000 / 年 (デバッグ用)',
            ...
            Row(
              ...
              children: [
                TextButton(
                  onPressed: () async {
                    await _launchURL(AppConstants.termsOfServiceUrl);
                  },
                  child: const Text(
                    '利用規約',
                    style: TextStyle(
                ...
                TextButton(
                  onPressed: () async {
                    await _launchURL(AppConstants.privacyPolicyUrl);
                  },
                  child: const Text(
                    'プライバシーポリシー',
                    style: TextStyle(
